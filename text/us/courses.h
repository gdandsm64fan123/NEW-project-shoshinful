COURSE_ACTS(COURSE_BOB, _(" 1 RIVER MOUNTAIN"),
...
COURSE_ACTS(COURSE_WF, _(" 2 MOUNTAIN"),
...
COURSE_ACTS(COURSE_JRB, _(" 3 WATER DUNGEON"),
...
COURSE_ACTS(COURSE_CCM, _(" 4 SNOW SLIDER"),
...
COURSE_ACTS(COURSE_BBH, _(" 5 BIG BOO'S FORTRESS"),
...
COURSE_ACTS(COURSE_HMC, _(" 6 UNDERGROUND CAVE"),
...
COURSE_ACTS(COURSE_LLL, _(" 7 FIRE BUBBLE"),
...
COURSE_ACTS(COURSE_SSL, _(" 8 DESERT LAND"),
...
COURSE_ACTS(COURSE_DDD, _(" 9 WATER LAND"),
...
COURSE_ACTS(COURSE_SL, _("10 SNOW MOUNTAIN"),
...
COURSE_ACTS(COURSE_WDW, _("11 WATER DUNGEON"),
...
COURSE_ACTS(COURSE_RR, _("15 RAINBOW CRUISE"),
...
SECRET_STAR(COURSE_SA, _("   AQUARIUM LIMBO"))
SECRET_STAR(COURSE_CAKE_END, _(""))

CASTLE_SECRET_STARS(_("   CASTLE SECRET STARS"))

EXTRA_TEXT(0, _("YOU FOUND SECRET STAR!"))
EXTRA_TEXT(1, _(""))
EXTRA_TEXT(2, _(""))
EXTRA_TEXT(3, _(""))
EXTRA_TEXT(4, _(""))
