...
#define HUD_POWER_METER_X            250
#define HUD_POWER_METER_EMPHASIZED_Y 200
#define HUD_POWER_METER_Y            200
#define HUD_POWER_METER_HIDDEN_Y     200

#define HUD_TOP_Y 209
#define HUD_BOTTOM_Y 19 // Same height as the Lakitu icon

#define HUD_COINS_X 84
#define HUD_STARS_X 168 // This starts counting from the right edge
#define HUD_CAMERA_X 999 // This starts counting from the right edge
